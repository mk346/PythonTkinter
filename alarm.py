...
music_or_beep = input("Enter m for a music or b for a beep sound:")
if music_or_beep == 'b':
...
while True:
    ...
    #strftime is a function that is used to convert date and time objects to their string representation
